...
const L2     = 11
const R2     = 12
const START  = 13   // start/menu
const SELECT = 14   // select/options/back/help
...
const padActionIdMaps = [
    {
        ...
        buttons: [A, B, X, Y, L1, R1, L2, R2, SELECT, START, 0, 0, UP, DOWN, LEFT, RIGHT],
    },
    {
        // xbox 360 gamepad profile
        axesSensitivity: 0.9,
        ...
        axesNegative: [LEFT,    UP,    LEFT,   UP],
        buttonsSensitivity: 0.2, 
        buttons: [A, B, X, Y, L1, R1, L2, R2, SELECT, SELECT, 0, 0, UP, DOWN, LEFT, RIGHT],
    },
    {
        // xbox 360 gamepad profile
        axesSensitivity: 0.9,
